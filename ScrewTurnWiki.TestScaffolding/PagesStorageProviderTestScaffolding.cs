...
namespace ScrewTurn.Wiki.Tests {
	...
	public abstract class PagesStorageProviderTestScaffolding {
		...
		protected IHostV50 MockHost() {
			...
			IGlobalSettingsStorageProviderV60 globalSettingsStorageProvider = mocks.DynamicMock<IGlobalSettingsStorageProviderV60>();
			...
			ISettingsStorageProviderV60 settingsStorageProvider = mocks.DynamicMock<ISettingsStorageProviderV60>();
			IUsersStorageProviderV60 usersStorageProvider = mocks.DynamicMock<IUsersStorageProviderV60>();
			...
			Expect.Call(globalSettingsStorageProvider.GetAllWikis()).Return(new[] { new Configuration.Wiki("root", new List<string>() { "localhost" }) });
			...
			ProviderCollector<IUsersStorageProviderV60> usersProvidersCollector = new ProviderCollector<IUsersStorageProviderV60>();
			...
			ProviderCollector<IPagesStorageProviderV60> pagesStorageProvider = new ProviderCollector<IPagesStorageProviderV60>();
			...
			Expect.Call(collectorsBox.FormatterProviderCollector).Return(new ProviderCollector<IFormatterProviderV50>()).Repeat.Any();
		...
		private class DummyUsersStorageProvider : IUsersStorageProviderV60 {
		...
		private class DummyPagesStorageProvider : IPagesStorageProviderV60 {
		...
		private class DummyIndexDirectoryProvider : IIndexDirectoryProviderV60 {
		...
		public abstract IPagesStorageProviderV60 GetProvider();
		...
		//    IPagesStorageProviderV50 prov = GetProvider();
