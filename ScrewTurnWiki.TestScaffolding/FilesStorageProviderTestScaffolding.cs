...
namespace ScrewTurn.Wiki.Tests {
	...
	public abstract class FilesStorageProviderTestScaffolding {
		...
		protected IPagesStorageProviderV60 MockPagesProvider() {
			IPagesStorageProviderV60 prov = mocks.DynamicMock<IPagesStorageProviderV60>();
		...
		public abstract IFilesStorageProviderV60 GetProvider();
