...
namespace ScrewTurn.Wiki {
	...
	public static class FormattedContent {
        ...
        /// </summary>
        /// <param name="wiki">The wiki.</param>
        /// <param name="content">The Content for formatted.</param>
        /// <returns>The formatted content.</returns>
        public static string GetFormattedPageContentForWysiwyg(string wiki, string content)
        {
            return FormattingPipeline.FormatForWysiwygWithPhase1And2(wiki, content, FormattingContext.PageContent);
        }
