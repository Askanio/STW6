...
namespace ScrewTurn.Wiki {
	...
	public class AuthWriter {
		...
		public AuthWriter(ISettingsStorageProviderV60 settingsProvider) {
		...
		/// <param name="directory">The directory.</param>
		/// <returns><c>true</c> if the operation succeeded, <c>false</c> otherwise.</returns>
		public bool RemoveEntriesForDirectory(UserGroup group, IFilesStorageProviderV60 provider, string directory) {
			if(group == null) throw new ArgumentNullException("group");
		...
		/// <param name="directory">The directory.</param>
		/// <returns><c>true</c> if the operation succeeded, <c>false</c> otherwise.</returns>
		public bool RemoveEntriesForDirectory(UserInfo user, IFilesStorageProviderV60 provider, string directory) {
			if(user == null) throw new ArgumentNullException("user");
