...
namespace ScrewTurn.Wiki {
	...
	public static class Settings {
		...
		/// </summary>
		public static ISettingsStorageProviderV60 GetProvider(string wiki) {
		...
		{
            var s = (string)Cache.GetCachedItem(wiki, "MainUrl", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("MainUrl"), "http://www.server.com/"));
		    if(!s.EndsWith("/")) s += "/";
			return s;
		}
		...
		public static void SetMainUrl(string wiki, string url) {
            ...
            Cache.AddToCache(wiki, "MainUrl", url);
		}
		...
		public static string GetWikiTitle(string wiki) {
            return (string)Cache.GetCachedItem(wiki, "WikiTitle", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("WikiTitle"), "ScrewTurn Wiki"));
		}
		...
		public static void SetWikiTitle(string wiki, string newWikiTitle) {
            ...
            Cache.AddToCache(wiki, "WikiTitle", newWikiTitle);
		}
		...
		public static bool GetPublicAccess(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "PublicAccess", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("PublicAccess"), false));
		}
		...
		public static void SetPublicAccess(string wiki, bool publicAccess) {
            ...
            Cache.AddToCache(wiki, "PublicAccess", publicAccess);
		}
		...
		public static bool GetPrivateAccess(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "PrivateAccess", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("PrivateAccess"), false));
		}
		...
		public static void SetPrivateAccess(string wiki, bool privateAccess) {	
            ...
            Cache.AddToCache(wiki, "PrivateAccess", privateAccess);
		}
		...
		public static bool GetFileManagementInPublicAccessAllowed(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "FileManagementInPublicAccessAllowed", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("FileManagementInPublicAccessAllowed"), false));
		}
		...
		public static void SetFileManagementInPublicAccessAllowed(string wiki, bool fileManagementInPublicAccessAllowed) {
            ...
            Cache.AddToCache(wiki, "FileManagementInPublicAccessAllowed", fileManagementInPublicAccessAllowed);
		}
		...
		public static bool UsersCanRegister(string wiki) {
			return (bool)Cache.GetCachedItem(wiki, "UsersCanRegister", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("UsersCanRegister"), true));
		}
		...
		public static void SetUsersCanRegister(string wiki, bool usersCanRegister) {
            ...
            Cache.AddToCache(wiki, "UsersCanRegister", usersCanRegister);
		}
		...
		public static bool GetDisableCaptchaControl(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "DisableCaptchaControl", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("DisableCaptchaControl"), false));
		}
		...
		public static void SetDisableCaptchaControl(string wiki, bool disableCaptchaControl) {
            ...
            Cache.AddToCache(wiki, "DisableCaptchaControl", disableCaptchaControl);
		}
		...
		public static bool GetEnableViewPageCodeFeature(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "EnableViewPageCode", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("EnableViewPageCode"), true));
		}
		...
		public static void SetEnableViewPageCodeFeature(string wiki, bool enableViewPageCodeFeature) {
            ...
            Cache.AddToCache(wiki, "EnableViewPageCode", enableViewPageCodeFeature);
		}
		...
		public static bool GetEnablePageInfoDiv(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "EnablePageInfoDiv", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("EnablePageInfoDiv"), true));
		}
		...
		public static void SetEnablePageInfoDiv(string wiki, bool enablePageInfoDiv) {
            ...
            Cache.AddToCache(wiki, "EnablePageInfoDiv", enablePageInfoDiv);
		}
		...
		public static bool GetEnablePageToolbar(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "EnablePageToolbar", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("EnablePageToolbar"), true));
		}
		...
		public static void SetEnablePageToolbar(string wiki, bool enablePageToolbar) {
            ...
            Cache.AddToCache(wiki, "EnablePageToolbar", enablePageToolbar);
		}
		...
		public static int GetListSize(string wiki) {
            return (int)Cache.GetCachedItem(wiki, "ListSize", () => SettingsTools.GetInt(GetProvider(wiki).GetSetting("ListSize"), 50));
		}
		...
		public static void SetListSize(string wiki, int listSize) {
            ...
            Cache.AddToCache(wiki, "ListSize", listSize);
		}
		...
		public static AccountActivationMode GetAccountActivationMode(string wiki) {
            string value = (string)Cache.GetCachedItem(wiki, "AccountActivationMode", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("AccountActivationMode"), "EMAIL"));
		...
		public static void SetAccountActivationMode(string wiki, AccountActivationMode accountActivationMode) {
            ...
            Cache.AddToCache(wiki, "AccountActivationMode", aa);
		}
		...
		public static ChangeModerationMode GetModerationMode(string wiki) {
            string value = (string)Cache.GetCachedItem(wiki, "ChangeModerationMode", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("ChangeModerationMode"),
		...
		public static void SetModerationMode(string wiki, ChangeModerationMode moderationMode) {
            ...
            Cache.AddToCache(wiki, "ChangeModerationMode", moderationMode.ToString());
		}
		...
		public static bool GetUsersCanCreateNewPages(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "UsersCanCreateNewPages", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("UsersCanCreateNewPages"), true));
		}
		...
		public static void SetUsersCanCreateNewPages(string wiki, bool usersCanCreateNewPages) {
            ...
            Cache.AddToCache(wiki, "UsersCanCreateNewPages", usersCanCreateNewPages);
		}
		...
		public static bool GetUsersCanViewFiles(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "UsersCanViewFiles", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("UsersCanViewFiles"), true));
		}
		...
		public static void SetUsersCanViewFiles(string wiki, bool usersCanViewFiles) {
            ...
            Cache.AddToCache(wiki, "UsersCanViewFiles", usersCanViewFiles);
		}
		...
		public static bool GetUsersCanUploadFiles(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "UsersCanUploadFiles", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("UsersCanUploadFiles"), false));
		}
		...
		public static void SetUsersCanUploadFiles(string wiki, bool usersCanUploadFiles) {
            ...
            Cache.AddToCache(wiki, "UsersCanUploadFiles", usersCanUploadFiles);
		}
		...
		public static bool GetUsersCanDeleteFiles(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "UsersCanDeleteFiles", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("UsersCanDeleteFiles"), false));
		}
		...
		public static void SetUsersCanDeleteFiles(string wiki, bool usersCanDeleteFiles) {
            ...
            Cache.AddToCache(wiki, "UsersCanDeleteFiles", usersCanDeleteFiles);
		}
		...
		public static bool GetUsersCanCreateNewCategories(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "UsersCanCreateNewCategories", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("UsersCanCreateNewCategories"), false));
		}
		...
		public static void SetUsersCanCreateNewCategories(string wiki, bool usersCanCreateNewCategories) {
            ...
            Cache.AddToCache(wiki, "UsersCanCreateNewCategories", usersCanCreateNewCategories);
		}
		...
		public static bool GetUsersCanManagePageCategories(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "UsersCanManagePageCategories", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("UsersCanManagePageCategories"), false));
		}
		...
		public static void SetUsersCanManagePageCategories(string wiki, bool usersCanManagePageCategories) {
            ...
            Cache.AddToCache(wiki, "UsersCanManagePageCategories", usersCanManagePageCategories);
		}
		...
		public static string GetDefaultLanguage(string wiki) {
            return (string)Cache.GetCachedItem(wiki, "DefaultLanguage", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("DefaultLanguage"), "en-US"));
		}
		...
		public static void SetDefaultLanguage(string wiki, string defaultLanguage) {
            ...
            Cache.AddToCache(wiki, "DefaultLanguage", defaultLanguage);
		}
		...
		public static string GetDefaultTimezone(string wiki) {
            return (string)Cache.GetCachedItem(wiki, "DefaultTimezone", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("DefaultTimezone"), null));
		}
		...
		public static void SetDefaultTimezone(string wiki, string timeZoneId) {
            ...
            Cache.AddToCache(wiki, "DefaultTimezone", timeZoneId);
		}
		...
		public static string GetDateTimeFormat(string wiki) {
            return (string)Cache.GetCachedItem(wiki, "DateTimeFormat", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("DateTimeFormat"), "yyyy'/'MM'/'dd' 'HH':'mm"));
		}
		...
		public static void SetDateTimeFormat(string wiki, string dateTimeFormat) {
            ...
            Cache.AddToCache(wiki, "DateTimeFormat", dateTimeFormat);
		}
		...
		public static string GetDefaultPage(string wiki) {
            return (string)Cache.GetCachedItem(wiki, "DefaultPage", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("DefaultPage"), "MainPage"));
		}
		...
		public static void SetDefaultPage(string wiki, string defaultPage) {
            ...
            Cache.AddToCache(wiki, "DefaultPage", defaultPage);
		}
		...
		public static int GetMaxRecentChangesToDisplay(string wiki) {
            return (int)Cache.GetCachedItem(wiki, "MaxRecentChangesToDisplay", () => SettingsTools.GetInt(GetProvider(wiki).GetSetting("MaxRecentChangesToDisplay"), 10));
		}
		...
		public static void SetMaxRecentChangesToDisplay(string wiki, int maxRecentChangesToDisplay) {
            ...
            Cache.AddToCache(wiki, "MaxRecentChangesToDisplay", maxRecentChangesToDisplay);
		}
		...
		public static bool GetEnableDoubleClickEditing(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "EnableDoubleClickEditing", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("EnableDoubleClickEditing"), false));
		}
		...
		public static void SetEnableDoubleClickEditing(string wiki, bool enableDoubleClickEditing) {
            ...
            Cache.AddToCache(wiki, "EnableDoubleClickEditing", enableDoubleClickEditing);
		}
		...
		public static bool GetEnableSectionEditing(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "EnableSectionEditing", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("EnableSectionEditing"), true));
		}
		...
		public static void SetEnableSectionEditing(string wiki, bool enableSelectionEditing) {
            ...
            Cache.AddToCache(wiki, "EnableSectionEditing", enableSelectionEditing);
		}
		...
		public static bool GetEnableSectionAnchors(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "EnableSectionAnchors", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("EnableSectionAnchors"), true));
		}
		...
		public static void SetEnableSectionAnchors(string wiki, bool enableSectionAnchors) {
            ...
            Cache.AddToCache(wiki, "EnableSectionAnchors", enableSectionAnchors);
		}
		...
		public static bool GetDisableBreadcrumbsTrail(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "DisableBreadcrumbsTrail", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("DisableBreadcrumbsTrail"), false));
		}
		...
		public static void SetDisableBreadcrumbsTrail(string wiki, bool disableBreadcrumbsTrail) {
            ...
            Cache.AddToCache(wiki, "DisableBreadcrumbsTrail", disableBreadcrumbsTrail);
		}
		...
		public static bool GetAutoGeneratePageNames(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "AutoGeneratePageNames", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("AutoGeneratePageNames"), true));
		}
		...
		public static void SetAutoGeneratePageNames(string wiki, bool autoGeneratePageNames) {
            ...
            Cache.AddToCache(wiki, "AutoGeneratePageNames", autoGeneratePageNames);
		}
		...
		public static bool GetProcessSingleLineBreaks(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "ProcessSingleLineBreaks", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("ProcessSingleLineBreaks"), false));
		}
		...
		public static void SetProcessSingleLineBreaks(string wiki, bool processSingleLineBreacks) {
            ...
            Cache.AddToCache(wiki, "ProcessSingleLineBreaks", processSingleLineBreacks);
		}
		...
		public static int GetKeptBackupNumber(string wiki) {
            return (int)Cache.GetCachedItem(wiki, "KeptBackupNumber", () => SettingsTools.GetInt(GetProvider(wiki).GetSetting("KeptBackupNumber"), -1));
		}
		...
		public static void SetKeptBackupNumber(string wiki, int numberOfBackup) {
            ...
            Cache.AddToCache(wiki, "KeptBackupNumber", numberOfBackup);
		}
		...
		public static string GetTheme(string wiki, string nspace) {
            ...
            return (string)Cache.GetCachedItem(wiki, propertyName, () => SettingsTools.GetString(GetProvider(wiki).GetSetting(propertyName), "standard|Default"));
		}
		...
		public static void SetTheme(string wiki, string nspace, string theme) {
            ...
            Cache.AddToCache(wiki, propertyName, theme);
		}
		...
		public static string[] GetAllowedFileTypes(string wiki) {
            string raw = (string)Cache.GetCachedItem(wiki, "AllowedFileTypes", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("AllowedFileTypes"), "jpg|jpeg|gif|png|tif|tiff|bmp|svg|htm|html|zip|rar|pdf|txt|doc|xls|ppt|docx|xlsx|pptx"));
		...
		public static void SetAllowedFileTypes(string wiki, string[] allowedFileTypes) {
            ...
            Cache.AddToCache(wiki, "AllowedFileTypes", res);
		}
		...
		public static FileDownloadCountFilterMode GetFileDownloadCountFilterMode(string wiki) {
            string raw = (string)Cache.GetCachedItem(wiki, "FileDownloadCountFilterMode", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("FileDownloadCountFilterMode"), FileDownloadCountFilterMode.CountAll.ToString()));
		...
		public static void SetFileDownloadCountFilterMode(string wiki, FileDownloadCountFilterMode fileDonwloadCountFilterMode) {
            ...
            Cache.AddToCache(wiki, "FileDownloadCountFilterMode", fileDonwloadCountFilterMode.ToString());
		}
		...
		public static string[] GetFileDownloadCountFilter(string wiki) {
            string raw = (string)Cache.GetCachedItem(wiki, "FileDownloadCountFilter", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("FileDownloadCountFilter"), ""));
			return raw.ToLowerInvariant().Split(new char[] { '|' }, StringSplitOptions.RemoveEmptyEntries);
		}
		...
		public static void SetFileDownloadCountFilter(string wiki, string[] fileDownloadCountFilter) {
            ...
            Cache.AddToCache(wiki, "FileDownloadCountFilter", res);
		}
		...
		public static bool GetScriptTagsAllowed(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "ScriptTagsAllowed", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("ScriptTagsAllowed"), false));
		}
		...
		public static void SetScriptTagsAllowed(string wiki, bool scriptTagAllowed) {
            ...
            Cache.AddToCache(wiki, "ScriptTagsAllowed", scriptTagAllowed);
		}
		...
		public static string GetIpHostFilter(string wiki) {
            return (string)Cache.GetCachedItem(wiki, "IpHostFilter", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("IpHostFilter"), ""));
		}
		...
		public static void SetIpHostFilter(string wiki, string ipHostFilter) {
            ...
            Cache.AddToCache(wiki, "IpHostFilter", ipHostFilter);
		}
		...
		public static int GetMaxRecentChanges(string wiki) {
            return (int)Cache.GetCachedItem(wiki, "MaxRecentChanges", () => SettingsTools.GetInt(GetProvider(wiki).GetSetting("MaxRecentChanges"), 100));
		}
		...
		public static void SetMaxRecentChanges(string wiki, int maxRecentChanges) {
            ...
            Cache.AddToCache(wiki, "MaxRecentChanges", maxRecentChanges);
		}
		...
		public static string GetDiscussionPermissions(string wiki) {
            return (string)Cache.GetCachedItem(wiki, "DiscussionPermissions", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("DiscussionPermissions"), "PAGE"));
		}
		...
		public static void SetDiscussionPermissions(string wiki, string discussionPermission) {
            ...
            Cache.AddToCache(wiki, "DiscussionPermissions", discussionPermission);
		}
		...
		public static bool GetDisableConcurrentEditing(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "DisableConcurrentEditing", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("DisableConcurrentEditing"), false));
		}
		...
		public static void SetDisableConcurrentEditing(string wiki, bool disableConcurrentEditing) {
            ...
            Cache.AddToCache(wiki, "DisableConcurrentEditing", disableConcurrentEditing);
		}

        /// <summary>
        /// Gets a value enable additionals global permissions for the given wiki.
        /// </summary>
        /// <param name="wiki">The wiki.</param>
        public static bool GetEnableAdditionalsGlobalPermissions(string wiki)
        {
            return (bool)Cache.GetCachedItem(wiki, "EnableAdditionalsGlobalPermissions", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("EnableAdditionalsGlobalPermissions"), false));
        }

        /// <summary>
        /// Sets enable additionals global permissions for the given wiki.
        /// </summary>
        /// <param name="wiki">The wiki.</param>
        /// <param name="enableAdditionalsPermissions">If set to <c>true</c> enable additionals global permissions.</param>
        public static void SetEnableAdditionalsGlobalPermissions(string wiki, bool enableAdditionalsPermissions)
        {
            GetProvider(wiki).SetSetting("EnableAdditionalsGlobalPermissions", SettingsTools.PrintBool(enableAdditionalsPermissions));
            Cache.AddToCache(wiki, "EnableAdditionalsGlobalPermissions", enableAdditionalsPermissions);
        }
		...
		public static bool GetUseVisualEditorAsDefault(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "UseVisualEditorAsDefault", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("UseVisualEditorAsDefault"), false));
		}
		...
		public static void SetUseVisualEditorAsDefault(string wiki, bool useVisualEditorAsDefault) {
            ...
            Cache.AddToCache(wiki, "UseVisualEditorAsDefault", useVisualEditorAsDefault);
		}
		...
		public static string GetAdministratorsGroup(string wiki) {
            return (string)Cache.GetCachedItem(wiki, "AdministratorsGroup", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("AdministratorsGroup"), "Administrators"));
		}
		...
		public static void SetAdministratorsGroup(string wiki, string administratorsGroup) {
            ...
            Cache.AddToCache(wiki, "AdministratorsGroup", administratorsGroup);
		}
		...
		public static string GetUsersGroup(string wiki) {
            return (string)Cache.GetCachedItem(wiki, "UsersGroup", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("UsersGroup"), "Users"));
		}
		...
		public static void SetUsersGroup(string wiki, string usersGroup) {
            ...
            Cache.AddToCache(wiki, "UsersGroup", usersGroup);
		}
		...
		public static string GetAnonymousGroup(string wiki) {
            return (string)Cache.GetCachedItem(wiki, "AnonymousGroup", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("AnonymousGroup"), "Anonymous"));
		}
		...
		public static void SetAnonymousGroup(string wiki, string anonymousGroup) {
            ...
            Cache.AddToCache(wiki, "AnonymousGroup", anonymousGroup);
		}
		...
		public static bool GetDisplayGravatars(string wiki) {
            return (bool)Cache.GetCachedItem(wiki, "DisplayGravatars", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("DisplayGravatars"), true));
		}
		...
		public static void SetDisplayGravatars(string wiki, bool displayGravatar) {
            ...
            Cache.AddToCache(wiki, "DisplayGravatars", displayGravatar);
		}
		...
		public static RssFeedsMode GetRssFeedsMode(string wiki) {
            string value = (string)Cache.GetCachedItem(wiki, "RssFeedsMode", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("RssFeedsMode"), RssFeedsMode.Summary.ToString()));
		...
		public static void SetRssFeedsMode(string wiki, RssFeedsMode rssFeedMode) {
            ...
            Cache.AddToCache(wiki, "RssFeedsMode", rssFeedMode.ToString());
		}
		...
		{
		    string value = (string) Cache.GetCachedItem(wiki, "LastPageIndexing", () =>
		                            SettingsTools.GetString(GetProvider(wiki).GetSetting("LastPageIndexing"), DateTime.Now.AddYears(-10).ToString("yyyyMMddHHmmss")));
		...
		public static void SetLastPageIndexing(string wiki, DateTime lastPageIndexingDateTime) {
            ...
            Cache.AddToCache(wiki, "LastPageIndexing", lastPageIndexingDateTime.ToString("yyyyMMddHHmmss"));
		}
        ...
        /// </summary>
        /// <param name="wiki">The wiki.</param>
        public static bool GetEnableOverlayingTextOnAnImage(string wiki)
        {
            return (bool)Cache.GetCachedItem(wiki, "EnableOverlayingTextOnAnImage", () => SettingsTools.GetBool(GetProvider(wiki).GetSetting("EnableOverlayingTextOnAnImage"), false));
        }
        ...
        /// </summary>
        /// <param name="wiki">The wiki.</param>
        /// <param name="enableOverlayingTextOnAnImage">If set to <c>true</c> enable overlaying text on an image.</param>
        public static void SetEnableOverlayingTextOnAnImage(string wiki, bool enableOverlayingTextOnAnImage)
        {
            GetProvider(wiki).SetSetting("EnableOverlayingTextOnAnImage", SettingsTools.PrintBool(enableOverlayingTextOnAnImage));
            Cache.AddToCache(wiki, "EnableOverlayingTextOnAnImage", enableOverlayingTextOnAnImage);
        }
        ...
        /// </summary>
        /// <param name="wiki">The wiki.</param>
        public static string GetOverlayingTextOnAnImage(string wiki)
        {
            return (string)Cache.GetCachedItem(wiki, "OverlayingTextOnAnImage", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("OverlayingTextOnAnImage"), String.Empty));
        }
        ...
        /// </summary>
        /// <param name="wiki">The wiki.</param>
        /// <param name="overlayingTextOnAnImage">Overlaying text.</param>
        public static void SetOverlayingTextOnAnImage(string wiki, string overlayingTextOnAnImage)
        {
            GetProvider(wiki).SetSetting("OverlayingTextOnAnImage", overlayingTextOnAnImage);
            Cache.AddToCache(wiki, "OverlayingTextOnAnImage", overlayingTextOnAnImage);
        }

        /// <summary>
        /// Gets the Name of Namespace Root for the given wiki.
        /// </summary>
        /// <param name="wiki">The wiki.</param>
        public static string GetRootNamespaceName(string wiki)
        {
            return (string)Cache.GetCachedItem(wiki, "RootNamespaceName", () => SettingsTools.GetString(GetProvider(wiki).GetSetting("RootNamespaceName"), "<root>"));
        }

        /// <summary>
        /// Sets the Name of Namespace Root for the given wiki.
        /// </summary>
        /// <param name="wiki">The wiki.</param>
        /// <param name="rootNamespaceName">The default name.</param>
        public static void SetRootNamespaceName(string wiki, string rootNamespaceName)
        {
            GetProvider(wiki).SetSetting("RootNamespaceName", rootNamespaceName);
