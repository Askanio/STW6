...
namespace ScrewTurn.Wiki {
	...
	public class Host : IHostV50 {
		...
		public bool StoreFile(string fullName, Stream source, bool overwrite) {
			...
			string wiki = GetCurrentWiki();
			string provider = GetDefaultProvider(typeof(IFilesStorageProviderV60));
		...
		public void LogEntry(string message, LogEntryType entryType, string user, object caller, string wiki = null) {
			...
			string name = "?";
			if(user == null) {
				if(caller is IUsersStorageProviderV60) name = ((IUsersStorageProviderV60)caller).Information.Name;
				else if(caller is IPagesStorageProviderV60) name = ((IPagesStorageProviderV60)caller).Information.Name;
				else if(caller is IFormatterProviderV50) name = ((IFormatterProviderV50)caller).Information.Name;
				else if(caller is ISettingsStorageProviderV60) name = ((ISettingsStorageProviderV60)caller).Information.Name;
				else if(caller is IGlobalSettingsStorageProviderV60) name = ((IGlobalSettingsStorageProviderV60)caller).Information.Name;
				else if(caller is IFilesStorageProviderV60) name = ((IFilesStorageProviderV60)caller).Information.Name;
        ...
        //public string AddToolbarItem(IProviderV50 caller, ToolbarItem item, string text, string value) {
        //    if(caller == null) throw new ArgumentNullException("caller");
		...
		/// <see cref="T:IPagesStorageProviderV50" />, 
		/// <see cref="T:IUsersStorageProviderV50" />, 
		/// <see cref="T:IFilesStorageProviderV50" />,
		/// <see cref="T:IThemesStorageProviderV50" />.</param>
		...
		public IPagesStorageProviderV60[] GetPagesStorageProviders() {
			string wiki = GetCurrentWiki();

			List<IPagesStorageProviderV60> pagesStorageProviders = new List<IPagesStorageProviderV60>();
			foreach(IPagesStorageProviderV60 pagesStorageProvider in Collectors.CollectorsBox.PagesProviderCollector.GetAllProviders(wiki)) {
		...
		/// </summary>
		/// <returns>The providers.</returns>
		public IUsersStorageProviderV60[] GetUsersStorageProviders() {
			string wiki = GetCurrentWiki();

			List<IUsersStorageProviderV60> usersStorageProviders = new List<IUsersStorageProviderV60>();
			foreach(IUsersStorageProviderV60 userStorageProvider in Collectors.CollectorsBox.UsersProviderCollector.GetAllProviders(wiki)) {
		...
		/// </summary>
		/// <returns>The providers.</returns>
		public IFilesStorageProviderV60[] GetFilesStorageProviders() {
			string wiki = GetCurrentWiki();

			List<IFilesStorageProviderV60> filesStorageProviders = new List<IFilesStorageProviderV60>();
			foreach(IFilesStorageProviderV60 filesStorageProvider in Collectors.CollectorsBox.FilesProviderCollector.GetAllProviders(wiki)) {
		...
		/// </summary>
		/// <returns>The providers.</returns>
		public IThemesStorageProviderV60[] GetThemesProviders() {
			string wiki = GetCurrentWiki();

			List<IThemesStorageProviderV60> themesStorageProviders = new List<IThemesStorageProviderV60>();
			foreach(IThemesStorageProviderV60 themesStorageProvider in Collectors.CollectorsBox.ThemesProviderCollector.GetAllProviders(wiki)) {
		...
		/// <returns>The providers.</returns>
		public IFormatterProviderV50[] GetFormatterProviders(bool enabled) {
			string wiki = GetCurrentWiki();

			List<IFormatterProviderV50> formatterProviders = new List<IFormatterProviderV50>();
			foreach(IFormatterProviderV50 formatterProvider in Collectors.CollectorsBox.FormatterProviderCollector.GetAllProviders(wiki)) {
		...
		public ISettingsStorageProviderV60 GetSettingsStorageProvider() {
			string wiki = GetCurrentWiki();
		...
		/// </summary>
		/// <returns>The global settings storage provider.</returns>
		public IGlobalSettingsStorageProviderV60 GetGlobalSettingsStorageProvider() {
		...
		public bool SetPluginConfiguration(IProviderV60 provider, string configuration) {
		...
		public void OnFileActivity(string provider, string file, string oldFileName, FileActivity activity) {
			...
			if(FileActivity != null) {
				IFilesStorageProviderV60 prov = Collectors.CollectorsBox.FilesProviderCollector.GetProvider(provider, wiki);
		...
		public string RegisterRequestHandler(IProviderV60 caller, string urlRegex, string[] methods) {
			if(caller == null) throw new ArgumentNullException("caller");
		...
		public string AddHtmlHeadContent(IProviderV60 caller, string content) {
			if(caller == null) throw new ArgumentNullException("caller");
