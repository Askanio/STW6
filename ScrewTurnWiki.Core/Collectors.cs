...
namespace ScrewTurn.Wiki {
	...
	public static class Collectors {
		...
		/// </summary>
		private static ProviderCollector<IUsersStorageProviderV60> _usersProviderCollector;

		/// <summary>
		/// The Theme Provider Collector istance.
		/// </summary>
		private static ProviderCollector<IThemesStorageProviderV60> _themeProviderCollector;

		/// <summary>
		/// The Pages Provider Collector instance.
		/// </summary>
		private static ProviderCollector<IPagesStorageProviderV60> _pagesProviderCollector;

		/// <summary>
		/// The Files Provider Collector instance.
		/// </summary>
		private static ProviderCollector<IFilesStorageProviderV60> _filesProviderCollector;

		/// <summary>
		/// The Formatter Provider Collector instance.
		/// </summary>
		private static ProviderCollector<IFormatterProviderV50> _formatterProviderCollector;
