...
namespace ScrewTurn.Wiki {
	...
	public class AuthReader {
		...
		/// </summary>
		private ISettingsStorageProviderV60 _settingsProvider;

		/// <summary>
		/// Initializes a new instance of the <see cref="AuthReader"/> class.
		/// </summary>
		/// <param name="settingsProvider">The settings provider.</param>
		public AuthReader(ISettingsStorageProviderV60 settingsProvider) {
		...
		/// <param name="directory">The directory.</param>
		/// <returns>The granted actions.</returns>
		public string[] RetrieveGrantsForDirectory(UserGroup group, IFilesStorageProviderV60 provider, string directory) {
			if(group == null) throw new ArgumentNullException("group");
		...
		/// <param name="directory">The directory.</param>
		/// <returns>The granted actions.</returns>
		public string[] RetrieveGrantsForDirectory(UserInfo user, IFilesStorageProviderV60 provider, string directory) {
			if(user == null) throw new ArgumentNullException("user");
		...
		/// <param name="directory">The directory.</param>
		/// <returns>The granted actions.</returns>
		private string[] RetrieveGrantsForDirectory(string subject, IFilesStorageProviderV60 provider, string directory) {
			if(provider == null) throw new ArgumentNullException("provider");
			if(directory == null) throw new ArgumentNullException("directory");
			if(directory.Length == 0) throw new ArgumentException("Directory cannot be empty", "directory");
