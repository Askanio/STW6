...
namespace ScrewTurn.Wiki {
	...
	public static class FormattingPipeline {
		...
		public static IList<IFormatterProviderV50> GetSortedFormatters(string wiki) {
			List<IFormatterProviderV50> providers = new List<IFormatterProviderV50>(Collectors.CollectorsBox.FormatterProviderCollector.GetAllProviders(wiki));
		...
		public static string FormatWithPhase3(string wiki, string raw, FormattingContext context, string currentPageFullName) {
			...
			// Phase 3
			foreach(IFormatterProviderV50 provider in GetSortedFormatters(wiki)) {
		...
		public static string PrepareTitle(string wiki, string title, bool forIndexing, FormattingContext context, string currentPageFullName) {
			...
			foreach(IFormatterProviderV50 prov in GetSortedFormatters(wiki)) {
