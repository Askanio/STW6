...
namespace ScrewTurn.Wiki {
	...
	public static class FilesAndAttachments {
		...
		public static IFilesStorageProviderV60 FindFileProvider(string wiki, string fullName) {
			if(fullName == null) throw new ArgumentNullException("fullName");
			if(string.IsNullOrEmpty(fullName)) throw new ArgumentException("Full Name cannot be empty", "fullName");

			fullName = NormalizeFullName(fullName);

			foreach(IFilesStorageProviderV60 provider in Collectors.CollectorsBox.FilesProviderCollector.GetAllProviders(wiki)) {
		...
		public static IFilesStorageProviderV60 FindDirectoryProvider(string wiki, string fullPath) {
		...
		public static IFilesStorageProviderV60 FindPageAttachmentProvider(string wiki, string pageFullName, string attachmentName) {
		...
		public static bool StorePageAttachment(IFilesStorageProviderV60 provider, string pageFullName, string name, Stream source, bool overwrite) {
			if(provider == null) throw new ArgumentNullException("provider");
		...
		public static bool DeletePageAttachment(IFilesStorageProviderV60 provider, string pageFullName, string name) {
			if(provider == null) throw new ArgumentNullException("provider");
			if(pageFullName == null) throw new ArgumentNullException("pageFullName");
			if(pageFullName.Length == 0) throw new ArgumentException("Page Full Name cannot be empty", "pageFullName");
			if(name == null) throw new ArgumentNullException("name");
