...
namespace ScrewTurn.Wiki.Web.Controllers
{
    public class HistoryController : PageController
    {
        ...
        [CheckAllowPageActionAttribute(Action = CheckAllowPageActionAttribute.ActionForPages.ReadPage, Order = 2)]
        [CheckAllowPageActionAttribute(Action = CheckAllowPageActionAttribute.ActionForPages.ManagePage, Order = 3)]
