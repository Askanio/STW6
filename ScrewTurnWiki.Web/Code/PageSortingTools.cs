...
namespace ScrewTurn.Wiki.Web.Code
{
    ...
    public static class PageSortingTools
    {
        ...
        private static DateTime GetMarkerDate(DateTime dt, out string label)
        {
            ...
            {
                label = Messages.EarlierThisWeek;
            ...
            {
                label = Messages.EarlierThisMonth + " (" + thisMonth.ToString("MMMM") + ")";
            ...
            {
                label = Messages.LastMonth + " (" + lastMonth.ToString("MMMM") + ")";
                return new DateTime(lastMonth.Year, lastMonth.Month, lastMonth.Day);
            }

            label = Messages.Older;
