...
namespace ScrewTurn.Wiki.Plugins.FSProviders {
	...
	/// </summary>
	public class FilesStorageProvider : ProviderBase, IFilesStorageProviderV60 {

        private readonly ComponentInformation info = new ComponentInformation("Local Files Provider", "Threeplicate Srl", "5.0.0.1", "http://www.sunhorizon.info", null);
		...
		public bool RetrievePageAttachment(string pageFullName, string name, Stream destinationStream) {
            ...
            try
            {
                ...
                //    StreamCopy(fs1, destinationStream);
