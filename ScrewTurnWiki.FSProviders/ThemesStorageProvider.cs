...
namespace ScrewTurn.Wiki.Plugins.FSProviders {
	...
	/// </summary>
	public class ThemesStorageProvider : ProviderBase, IThemesStorageProviderV60 {
		...
		private readonly ComponentInformation info =
			new ComponentInformation(ProviderName, "Threeplicate Srl", "4.0.5.143", "http://www.sunhorizon.info", null);
		private IHostV50 host;
		private string wiki;
		...
		private string GetRelativePath(string file) {
            ...
            return file.Substring(file.IndexOf(publicPath.Parent.Name)).Replace(Path.DirectorySeparatorChar.ToString(), "/");
		}
        ...
        void IProviderV60.ValidateConfig(string config) {}
