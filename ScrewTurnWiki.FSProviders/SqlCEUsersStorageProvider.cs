...
namespace ScrewTurn.Wiki.Plugins.FSProviders {
	...
	/// </summary>
	public class SqlCEUsersStorageProvider : SqlUsersStorageProviderBase, IUsersStorageProviderV60 {

		private readonly ComponentInformation info = new ComponentInformation("SQL CE Users Storage Provider", "Threeplicate Srl", "5.0.0.1", "http://www.sunhorizon.info", null);
