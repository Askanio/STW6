...
namespace ScrewTurn.Wiki.Plugins.FSProviders {
	...
	/// </summary>
	public class SqlCESettingsStorageProvider : SqlSettingsStorageProviderBase, ISettingsStorageProviderV60 {

		private readonly ComponentInformation info = new ComponentInformation("SQL CE Settings Storage Provider", "Threeplicate Srl", "5.0.0.1", "http://www.sunhorizon.info", null);
