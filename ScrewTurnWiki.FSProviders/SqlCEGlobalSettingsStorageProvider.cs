...
namespace ScrewTurn.Wiki.Plugins.FSProviders {
	...
	/// </summary>
	public class SqlCEGlobalSettingsStorageProvider : SqlGlobalSettingsStorageProviderBase, IGlobalSettingsStorageProviderV60 {

        private readonly ComponentInformation info = new ComponentInformation("SQL CE Global Settings Storage Provider", "Threeplicate Srl", "5.0.0.1", "http://www.sunhorizon.info", null);
		...
		private void CreateDatabaseIfNotExists(string connString) {
            connString = connString.Replace("|DataDirectory|", AppDomain.CurrentDomain.GetData("DataDirectory").ToString());
