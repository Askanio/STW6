...
namespace ScrewTurn.Wiki.Plugins.SqlServer {
	...
	public class SqlServerSettingsStorageProvider : SqlSettingsStorageProviderBase {
        ...
        private readonly ComponentInformation info = new ComponentInformation("SQL Server Settings Storage Provider", "Threeplicate Srl", "5.0.0.1", "http://www.sunhorizon.info", null);
