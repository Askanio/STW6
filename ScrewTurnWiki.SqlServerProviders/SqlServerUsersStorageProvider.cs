...
namespace ScrewTurn.Wiki.Plugins.SqlServer {
	...
	public class SqlServerUsersStorageProvider : SqlUsersStorageProviderBase {
        ...
        private readonly ComponentInformation info = new ComponentInformation("SQL Server Users Storage Provider", "Threeplicate Srl", "5.0.0.1", "http://www.sunhorizon.info", null);
