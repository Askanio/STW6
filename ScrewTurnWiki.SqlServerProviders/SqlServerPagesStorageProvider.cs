...
namespace ScrewTurn.Wiki.Plugins.SqlServer {
	...
	public class SqlServerPagesStorageProvider : SqlPagesStorageProviderBase {
        ...
        private readonly ComponentInformation info = new ComponentInformation("SQL Server Pages Storage Provider", "Threeplicate Srl", "5.0.0.1", "http://www.sunhorizon.info", null);
