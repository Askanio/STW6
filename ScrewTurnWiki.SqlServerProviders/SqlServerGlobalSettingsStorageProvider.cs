...
namespace ScrewTurn.Wiki.Plugins.SqlServer {
	...
	public class SqlServerGlobalSettingsStorageProvider : SqlGlobalSettingsStorageProviderBase {
        ...
        private readonly ComponentInformation info = new ComponentInformation("SQL Server Global Settings Storage Provider", "Threeplicate Srl", "5.0.0.1", "http://www.sunhorizon.info", null);
