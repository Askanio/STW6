...
namespace ScrewTurn.Wiki.Plugins.SqlServer {
	...
	public class SqlServerFilesStorageProvider : SqlFilesStorageProviderBase {
        ...
        private readonly ComponentInformation info = new ComponentInformation("SQL Server Files Storage Provider", "Threeplicate Srl", "5.0.0.1", "http://www.sunhorizon.info", null);
