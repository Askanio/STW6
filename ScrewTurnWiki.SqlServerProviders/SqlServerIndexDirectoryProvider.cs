...
namespace ScrewTurn.Wiki.Plugins.SqlServer {
	...
	/// </summary>
	public class SqlServerIndexDirectoryProvider : SqlStorageProviderBase, IIndexDirectoryProviderV60 {
		...
		public override ComponentInformation Information {
            get { return new ComponentInformation("Sql Server IndexDirectory Provider", "Threeplicate Srl", "4.0.5.143", "http://www.sunhorizon.info", null); }
		}
