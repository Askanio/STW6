...
References\Tools\ResxSync\resxsync.exe ScrewTurnWiki.Web\Localization\Common\Error.resx *
References\Tools\ResxSync\resxsync.exe ScrewTurnWiki.Web\Localization\Common\History.resx *
...
References\Tools\ResxSync\resxsync.exe ScrewTurnWiki.Web\Localization\Common\Edit.resx *
