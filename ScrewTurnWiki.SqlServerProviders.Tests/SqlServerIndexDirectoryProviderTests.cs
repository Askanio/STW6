...
namespace ScrewTurn.Wiki.Plugins.SqlServer.Tests {
	...
	public class SqlServerIndexDirectoryProviderTests {
		...
		public void AddPageTest() {
			...
			Collectors.AddProvider(typeof(SqlServerIndexDirectoryProvider), System.Reflection.Assembly.GetAssembly(typeof(SqlServerIndexDirectoryProvider)), ConnString + InitialCatalog, typeof(IIndexDirectoryProviderV60));
			Host.Instance = new Host();
			Host.Instance.OverridePublicDirectory(testDir);

			ProviderLoader.SetUp<IIndexDirectoryProviderV60>(typeof(SqlServerIndexDirectoryProvider), ConnString + InitialCatalog);
