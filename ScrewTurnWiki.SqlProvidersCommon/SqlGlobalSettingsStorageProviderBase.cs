...
namespace ScrewTurn.Wiki.Plugins.SqlCommon {
	...
	/// </summary>
	public abstract class SqlGlobalSettingsStorageProviderBase : SqlStorageProviderBase, IGlobalSettingsStorageProviderV60 {
        ...
        public virtual void ValidateConfig(string config) { }
		...
		public Configuration.Wiki[] GetAllWikis() {
