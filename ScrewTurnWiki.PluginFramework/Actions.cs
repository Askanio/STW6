...
namespace ScrewTurn.Wiki {
	...
	public static class Actions {
		...
		public static class ForGlobals {
            ...
            /// </summary>
            public const string AccessUserProfile = "User_Profile";

            /// <summary>
            /// Gets an array containing base actions.
            /// </summary>
            public static readonly string[] Base = new string[] {
				ManageAccounts,
				ManageGroups,
            ...
            /// <summary>
            /// Gets an array containing additional actions.
            /// </summary>
            public static readonly string[] Additional = new string[] {
                AccessUserProfile
			};
		    ...
		    /// </summary>
            public static readonly string[] All = Base.Concat(Additional).ToArray();
