...
namespace ScrewTurn.Wiki.PluginFramework {
	...
	public interface IHostV50 {
		...
		/// <returns>The <see cref="UserInfo" />, or <c>null</c> if no users are found.</returns>
		...
		/// </summary>
		/// <param name="name">The name.</param>
		/// <returns>The <see cref="UserGroup "/>, or <c>null</c> if no groups are found.</returns>
		...
		/// </summary>
		/// <param name="name">The name.</param>
		/// <returns>The <see cref="NamespaceInfo" />, or <c>null</c> if no namespaces are found.</returns>
        ...
        //string AddToolbarItem(IProviderV50 caller, ToolbarItem item, string text, string value);
		...
		/// <see cref="IPagesStorageProviderV60" />, 
		/// <see cref="IUsersStorageProviderV60" />, 
		/// <see cref="IFilesStorageProviderV60" />,
		/// <see cref="IFormatterProviderV50" />).</param>
		...
		IPagesStorageProviderV60[] GetPagesStorageProviders();

		/// <summary>
		/// Gets the users storage providers.
		/// </summary>
		/// <returns>The providers.</returns>
		IUsersStorageProviderV60[] GetUsersStorageProviders();

		/// <summary>
		/// Gets the files storage providers.
		/// </summary>
		/// <returns>The providers.</returns>
		IFilesStorageProviderV60[] GetFilesStorageProviders();

		/// <summary>
		/// Gets the theme providers.
		/// </summary>
		/// <returns>The providers.</returns>
		IThemesStorageProviderV60[] GetThemesProviders();
		...
		/// <returns>The providers.</returns>
		IFormatterProviderV50[] GetFormatterProviders(bool enabled);

		/// <summary>
		/// Gets the current settings storage provider.
		/// </summary>
		/// <returns>The global settings storage provider.</returns>
		ISettingsStorageProviderV60 GetSettingsStorageProvider();

		/// <summary>
		/// Gets the current global settings storage provider.
		/// </summary>
		/// <returns>The global settings storage provider.</returns>
		IGlobalSettingsStorageProviderV60 GetGlobalSettingsStorageProvider();
		...
		bool SetPluginConfiguration(IProviderV60 provider, string configuration);
		...
		string RegisterRequestHandler(IProviderV60 caller, string urlRegex, string[] methods);
		...
		string AddHtmlHeadContent(IProviderV60 caller, string content);
